...
#Give the country parameter a default value, such as “Unknown”.Step 2: Print a Message
#Inside the function, set up the code to display a sentence like “ is in “.
#Replace <city> and <country> with the parameter values.
#Step 3: Call the FunctionCall the describe_city() function with different city and country combinations.
